const articles =  [
   { id:1, title: "Why every one should learn how to code",
    ...
    comments: ["Good post", "I like this post"],reactions: ["U+1F600", "U+1F600"], giphys: [null]},
    { id:2, title: "The art of self acceptance",
    ...
    { id:3, title: "How to start a business",
    createdAt:"Wednesday, Mar 9, 2022",
    description:"Your first step in learning how to start a business is to identify a problem and solution. This is because successful startups begin from business ideas that fill the needs of a group of customers. But your idea doesn’t always have to be a new one. You can update existing products or services in a way that’s better for the consumer.For instance, Apple started from Steve Jobs’ original idea for a computer and has since created enhanced versions that better fit the market. They’ve also continued to evolve newer products like iPhones and iPads, making them more useful with each update.One example is how they’re adding a keyboard for iPads that’ll make them easier to use like a laptop.2 All these innovations by Apple led to them being worth of over a billion dollars. ",comments: [ "Not a bad post"],reactions:  ["U+1F600"], giphys: [null]},
    { id:4, title: "why happiness matter", createdAt:"Thursday, Mar 10, 2022",
    ...
    { id:5, title: "Today I spilt my coffee", createdAt:"Thursday, Mar 10, 2022", description:"Well that was a big oops. Everyone in the shop saw what happened. Can't get over it",comments: ["Hahaha that happened to me too!", "Don't worry about it"],reactions: ["U+1F600", "U+1F600"], giphys: [null]},
    { id:6, title: "Feeling happy", createdAt:"Friday, Mar 11, 2022", description:"Today's weather is really affecting my mood in a positive way. Hope it stays like this",comments: ["I love days like this.", "Bring on the sun!"],reactions:  [null], giphys: [null]},
    { id:7, title: "Need some ideas", createdAt:"Friday, Mar 11, 2022", description:"Anyone know any new recipes I could try using salmon?",comments: ["You could try putting it on the oven with some herbs, lemon and garlic", "Salmon! YUCK!"],reactions:  ["U+1F600"], giphys: [null]},
    { id:8, title: "Yeah baby!", createdAt:"Friday, Mar 11, 2022", description:"Just got a pay rise once again. I can really see my work paying off.",comments: ["Lucky you :( ", "Make sure you're still saving! Otherwise it will be pointless"],reactions: ["U+1F600", "U+1F600", "U+1F602"], giphys: [null]}
]
